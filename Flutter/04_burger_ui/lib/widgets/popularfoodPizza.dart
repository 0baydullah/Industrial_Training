...
class PopularFoodPizza extends StatefulWidget {
  PopularFoodPizza(this.img,this.price,{super.key});
  String img;
  int price;
  @override
  State<PopularFoodPizza> createState() => _PopularFoodState();
}

class _PopularFoodState extends State<PopularFoodPizza> {
  @override
