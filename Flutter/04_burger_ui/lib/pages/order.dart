import 'package:burger_ui/pages/cart.dart';
import 'package:burger_ui/widgets/size_button_decoration.dart';
...
class Order extends StatefulWidget {
  Order(this.img,this.price,{super.key});
  String img;
  int price;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        Size(32.0, 2, widget.img),


        SizeButtonDecoration(select, widget.img),
